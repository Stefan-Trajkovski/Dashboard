...
export default function EditFoodListM() {
  ...
  const {setShowAddFoodList} = context;
...
overflow-scroll
      ...
      dMain bg-[#F8F9FC] w-full xl:w-[97%] h-full xl:my-5 mx-auto  font-mulish   
    ...
    <div>
    <span onClick={()=>{setShowAddFoodList(false)}} className=' cursor-pointer text-3xl w-12/12  xl:w-8/12  flex justify-end items-center pe-1'><IoMdClose /></span>
    </div>
        </div>
          ...
          <div className='left w-full xl:w-8/12 space-y-4 px-5'> 
            <div className='w-full flex flex-col md:flex-row gap-5'>
              <div className='edit logo w-full md:w-6/12 p-4 bg-white shadow-md'>
                <p className='ps-2 text-[#B58C43] font-bold text-lg'>Add New Image</p> 
                <div className='flex p-3 justify-between gap-8'>
                  <input className='rounded-md ps-4 pe-2 bg-[#F8F9FC] w-full' placeholder='Upload Image'></input>
              ...
              <div className='edit logo w-full md:w-6/12 p-4 bg-white shadow-md'>
                ...
                <div className='p-3'>
                  <input className='rounded-md p-3 ps-4 pe-2 bg-[#F8F9FC] w-full' placeholder='Write the title'></input>
                </div>
              </div>
            </div>
            ...
            <div className='w-full flex flex-col md:flex-row gap-5'>
              <div className='flex w-full md:w-6/12 shadow-md'>
                <div className='connected logo w-6/12 p-4 bg-white shadow-none'>
                  ...
                  <div className='p-3'>
                    <input className='rounded-md p-3 ps-4 pe-2 bg-[#F8F9FC] w-full'  placeholder='Write The Price'></input>
                  </div>
                </div>
                <div className='connected logo w-6/12 p-4 bg-white shadow-none'>
       ...
       '>
            ...
            <div className=' grid text-[#B58C43] justify-items-center  md:flex  grid-cols-3 pb-2  md:w-6/12 justify-around items-center bg-white space-x-1 space-y-2 shadow-md   '>
              ...
              <div className=' pt-2 '>
                ...
                <input className='bg-[#F8F9FC] text-[#F8F9FC] ps-1 py-2 rounded'  size={4} placeholder='Type'></input>
              </div>
...
<div className=' h-3/6 flex flex-col p-4 bg-white mx-5 shadow-md'>
  ...
  <textarea 
    ...
    className="text-[#8C8C8C] block p-2.5 text-lg  h-full  resize-none  w-full  h-fit 
